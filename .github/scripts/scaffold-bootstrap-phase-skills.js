...
- How to Verify: compare the retained outputs, \`.github/.bootstrap-state.json\` entry, and state transition against the matching Phase ${phase.phase} section in \`.github/skills/generate-copilot-config/SKILL.md\` and \`.github/schemas/bootstrap-phase-state.schema.json\`.
